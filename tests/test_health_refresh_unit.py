...
def test_refresh_report_json_zone_health_only_missing_snapshot(
    ...
    res = refresh_report_json_zone_health_only(mock_cfg, opts)
...
def test_refresh_report_json_zone_health_only_success(
    mock_save: MagicMock,
